...
/**
 * Freelancer Activities Page.
 * Implements advanced filtering, search, and pagination for freelancer activities.
 */
    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-text-primary tracking-tight">Activities</h1>
                    <p className="text-text-secondary mt-1">Track your progress and interactions on the platform</p>
                </div>
                <div className="w-full md:w-96">
                    <SearchBar onSearch={setSearchQuery} placeholder="Search by title or description..." />
                </div>
            </div>
